...
## Mission 9 (scheduled 2026-09-13)

- Review 8 should-fix 1–4; FINAL-REPORT-8 §5 decisions 1–5 per DESIGN
  v3.8 §25; `quiet_hours` retired; playbook must match the committed file;
  stale ruff exclude removed.
